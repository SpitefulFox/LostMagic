...
public abstract class TheorycraftCard { 
	...
	/**
	 * The item required to complete this operation.
	 * If a null is returned no item are required. The array itself can contain null itemstacks -
	 * that signifies an item is required, but it will display as a ? in the GUI.
	 * You need to take care of consuming and checking for those item yourself in the activate method (see below).
	 * Non-null item will be handled by automatically.
	 * @return
	 */
	...
	/**
	 * Will the listed item be consumed when the card is picked.
	 * @return
	 */
	 ...
	 * You need to do all the proper checks for item carried and so forth in this method,
