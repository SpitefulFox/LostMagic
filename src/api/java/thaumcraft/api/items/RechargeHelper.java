 ...
 * @author Azanor
 * 
 * Helper methods to manipulate charge in item that use IRechargable.
 * 
 */
public class RechargeHelper {
	 ...
	 * Call it wherever you need to call it from, but only if you add some way to recharge such item.
