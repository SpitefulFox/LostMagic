 ...
 *
 *
 * IMPORTANT: If you are adding your own aspects to item it is a good idea to do it AFTER Thaumcraft adds its aspects, otherwise odd things may happen.
 *
 */
public class ThaumcraftApi {
	...
	/**
	 * This method is used to determine what bonus item are generated when the infernal furnace smelts item
	...
	public static class BluePrint implements IThaumcraftRecipe{
		...
		/**
		 * the item needed to craft this block - used for listing in the thaumonomicon and does not influance the actual recipe
		 * @return
		 */
	 ...
	 * and a diamond is 50.
	 * The weights are the same for all loot bag types - the only difference is how many item the bag
	 * contains.
	 * @param item
	 * @param weight
	 ...
	 * If your seed item use IPlantable it might not be necessary to do this as I
